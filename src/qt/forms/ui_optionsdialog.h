...
public:
    ...
    void retranslateUi(QDialog *OptionsDialog)
    {
...
#ifndef QT_NO_TOOLTIP
        externalSignerPath->setToolTip(QApplication::translate("OptionsDialog", "Full path to a Bitcoin Core compatible script (e.g. C:\\Downloads\\hwi.exe or /Users/you/Downloads/hwi.py). Beware: malware can steal your coins!", nullptr));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        mapPortNatpmp->setToolTip(QApplication::translate("OptionsDialog", "Automatically open the Bitcoin client port on the router. This only works when your router supports NAT-PMP and it is enabled. The external port could be random.", nullptr));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        connectSocksTor->setToolTip(QApplication::translate("OptionsDialog", "Connect to the Bitcoin network through a separate SOCKS5 proxy for Tor onion services.", nullptr));
#endif // QT_NO_TOOLTIP
        ...
        overriddenByCommandLineInfoLabel->setText(QApplication::translate("OptionsDialog", "Options set in this dialog are overridden by the command line or in the configuration file:", nullptr));
