...
public:
    ...
    void setupUi(QDialog *HelpMessageDialog)
    {
        ...
        versionPlusPlusLabel = new QLabel(HelpMessageDialog);
        versionPlusPlusLabel->setObjectName(QString::fromUtf8("versionPlusPlusLabel"));
        versionPlusPlusLabel->setMaximumSize(QSize(16777215, 30));
        QFont font;
        font.setBold(true);
        font.setWeight(75);
        versionPlusPlusLabel->setFont(font);
        versionPlusPlusLabel->setScaledContents(false);
        versionPlusPlusLabel->setAlignment(Qt::AlignHCenter|Qt::AlignTop);
        versionPlusPlusLabel->setWordWrap(true);
        versionPlusPlusLabel->setOpenExternalLinks(false);

        verticalLayoutLogo->addWidget(versionPlusPlusLabel);
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 638, 135));
    ...
    {
        versionPlusPlusLabel->setText(QApplication::translate("HelpMessageDialog", "Version++", nullptr));
