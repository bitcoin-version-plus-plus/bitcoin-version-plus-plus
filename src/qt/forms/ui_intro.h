...
public:
    ...
    void retranslateUi(QDialog *Intro)
    {
        ...
        prune->setText(QApplication::translate("Intro", "Limit block chain storage to", nullptr));
#ifndef QT_NO_TOOLTIP
        prune->setToolTip(QApplication::translate("Intro", "Reverting this setting requires re-downloading the entire blockchain. It is faster to download the full chain first and prune it later. Disables some advanced features.", nullptr));
#endif // QT_NO_TOOLTIP
        pruneGB->setSuffix(QApplication::translate("Intro", " GB", nullptr));
    } // retranslateUi
